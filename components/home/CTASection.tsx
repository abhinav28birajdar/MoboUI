  ...
  return (
    <section className="py-32 bg-white dark:bg-zinc-950 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-6 text-center relative z-10">
        <h2 className="text-4xl md:text-6xl font-black text-zinc-900 dark:text-white mb-6 tracking-tight">Start building today.</h2>
        <p className="text-xl text-zinc-600 dark:text-zinc-400 mb-10 max-w-2xl mx-auto">Free, open source, and ready for production. Stop writing boilerplate and start shipping.</p>
