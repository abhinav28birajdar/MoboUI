...
export function PlaygroundPreview() {
  return (
    <section className="py-24 bg-zinc-50 dark:bg-zinc-900/30 border-y border-zinc-200 dark:border-zinc-900 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-zinc-900 dark:text-white mb-6">Tweak it in the browser</h2>
          ...
          <div className="flex justify-center lg:justify-end relative">
            <EmulatorFrame className="scale-90 md:scale-100 origin-center lg:origin-right transform transition-transform hover:scale-105 duration-500">
              <div className="h-full w-full flex items-center justify-center bg-zinc-50 dark:bg-zinc-900 flex-col gap-4">
                 <div className="w-16 h-16 bg-accent rounded-full animate-bounce" />
                 <span className="text-zinc-500 dark:text-zinc-400 font-medium">Live Preview</span>
              </div>
            </EmulatorFrame>
          </div>
        </div>
