...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-bg-dark transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        primary: 'bg-accent text-zinc-900 dark:text-white hover:bg-accent-glow',
        secondary: 'bg-zinc-200 dark:bg-zinc-800 text-zinc-100 hover:bg-zinc-700',
        destructive: 'bg-error text-zinc-900 dark:text-white hover:bg-error/90',
        outline: 'border border-accent text-accent hover:bg-accent/10',
        ghost: 'hover:bg-zinc-200 dark:bg-zinc-800 hover:text-zinc-100',
