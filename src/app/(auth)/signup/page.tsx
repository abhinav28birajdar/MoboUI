...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f0f14] relative overflow-hidden py-20 px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 font-medium">Join the MOBOUI developers marketplace today.</p>
        </div>
        ...
        <div className="p-10 rounded-[2rem] border border-[#2a2a38] bg-[#1a1a24] shadow-2xl space-y-8">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <span className="relative bg-[#1a1a24] px-4 text-[10px] font-black text-slate-500 uppercase tracking-widest">Or sign up with email</span>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <User className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-fuchsia-600 transition-colors" size={20} />
                <input
                  type="text"
                  {...register('fullName')}
                  required
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <UserCheck className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-fuchsia-600 transition-colors" size={20} />
                <input
                  type="text"
                  {...register('username')}
                  required
              ...
              {errors.username && <p className="text-xs text-red-500 font-bold mt-1">{errors.username.message}</p>}
            </div>
            ...
            <div className="flex flex-col gap-2 pl-1">
              <label className="flex items-start gap-3 cursor-pointer text-xs text-slate-400">
                <input
                  ...
                  className="mt-1 accent-fuchsia-600 border border-[#2a2a38] rounded"
                  disabled={loading}
                />
                <span>
                  I agree to the{' '}
                  <Link href="/terms" className="text-fuchsia-600 hover:underline">Terms of Service</Link>
                  {' '}and{' '}
                  <Link href="/privacy" className="text-fuchsia-600 hover:underline">Privacy Policy</Link>.
                </span>
              </label>
              {errors.acceptTerms && <p className="text-xs text-red-500 font-bold mt-1">{errors.acceptTerms.message}</p>}
            </div>
        ...
        <p className="mt-10 text-center text-slate-400 text-sm">
          ...
          <Link href="/login" className="text-white font-bold hover:text-fuchsia-600 transition-colors underline underline-offset-4">
            Log in
          </Link>
        </p>
      </div>
