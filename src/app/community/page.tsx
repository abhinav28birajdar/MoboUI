            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-32">
                    {[
                        ...
                        <div key={i} className={cn("p-10 rounded-[3rem] border border-white/5 bg-surface transition-all hover:scale-[1.02] shadow-2xl", item.color)}>
                            <div className="h-16 w-16 rounded-2xl bg-white/5 flex items-center justify-center text-primary mb-8 border border-white/5">
                                {item.icon}
                            </div>
                            ...
                            <Button variant="outline" className="w-full h-14 rounded-2xl border-white/10 hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all font-bold">
                                {item.action}
                            </Button>
                        </div>
                    ))}
                ...
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-black text-white mb-12 text-center uppercase tracking-tighter">
                        Real-time <span className="text-primary">Activity.</span>
                    </h2>
                        ...
                        {[
                            ...
                            <div key={i} className="flex items-center justify-between p-6 rounded-3xl bg-neutral-900/30 border border-white/5 hover:bg-neutral-900 transition-colors group">
                                <div className="flex items-center gap-4">
                                    <div className="h-10 w-10 rounded-full bg-neutral-800 border border-white/10 flex items-center justify-center text-neutral-500 group-hover:text-primary transition-colors">
                                        {activity.icon}
                                    </div>
                                    <div className="text-sm">
                                        <span className="font-bold text-white">@{activity.user}</span>
                                        <span className="text-neutral-400"> {activity.action} </span>
                                        <span className="font-bold text-primary">{activity.item}</span>
                                    </div>
                                </div>
